...
**Level:** Level 1
**Task:** Task 2 – Responsive Landing Page
**Project:** TechStudioX Landing Page

## 👩‍💻 Author

**Ande Pallavi Bhavani**

MCA Graduate | Aspiring Java Full Stack Developer

**Technologies**

Java • Spring Boot • React • JavaScript • HTML • CSS • MySQL

## Acknowledgement

    This project was developed as part of the RaushByte Technologies Web Development Internship to gain practical experience in frontend development, responsive design, and web development best practices.
